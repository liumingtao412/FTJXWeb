<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" 
    CodeFile="TechAdmin.aspx.cs" Inherits="Admin_TechAdmin" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="RightContentPlaceHolder" Runat="Server">
     <asp:Panel ID="TechListPanel" runat="server">
        <div class="savePage">
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="标题">
                    <ItemTemplate>
                        <a href="/TechDetails.aspx?articleID=<%#Eval("编号") %>" target="_blank">
                            <asp:Label ID="Label1" runat="server" Text='<%#Convert.ToBoolean(Eval("IsTop")) ? "<font color=\"red\">[置顶]</font>" + Eval("articleTitle") : Eval("articleTitle") %>'>
                ...
                <asp:BoundField DataField="articleClickTimes" HeaderText="点击量" ReadOnly="True" SortExpression="clicks">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
                <asp:BoundField DataField="articleTime" HeaderText="添加时间" ReadOnly="True" SortExpression="addTime">
                    <HeaderStyle HorizontalAlign="Center" />
                    <ItemStyle HorizontalAlign="Center" />
                </asp:BoundField>
            </Columns>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mydbConnectionString %>"
            SelectCommand="SELECT * FROM [JSZCTable] Where articleDelete=False ORDER BY isTop,articleTime DESC"
