<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" 
    CodeFile="BannerAdmin.aspx.cs" Inherits="Admin_BannerAdmin" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="RightContentPlaceHolder" Runat="Server">
    <asp:Panel ID="NewsListPanel" runat="server">
        <div class="savePage">
            <asp:Button ID="Button1" runat="server" Text="添加Banner" OnClick="Article_New" />
        </div>
                ...
                <asp:TemplateField HeaderText="Banner名称">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton3" runat="server" CommandName="doEdit" CommandArgument='<%#Eval("编号") %>'
                            OnCommand="Article_Command">
                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("imgText")%>'></asp:Label>
                        </asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="链接URL">
                    <ItemTemplate>
                        <a href='<%#Eval("imgLink")%>' target="_blank">
                            <asp:Label runat="server" Text='<%#Eval("imgLink")%>'></asp:Label>
                        </a>
                    </ItemTemplate>
                </asp:TemplateField>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mydbConnectionString %>"
            SelectCommand="SELECT * FROM [BannerImageTable] WHERE IsDel=False ORDER BY PosIndex DESC"
    ...
    <asp:Panel ID="EditPanel" runat="server" Visible="false">
        ...
        <asp:Table ID="editTable" runat="server" BorderColor="#999999" BorderWidth="0px"
            ...
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" Font-Bold="True" Width="100px">Banner名称</asp:TableCell>
                <asp:TableCell runat="server" ColumnSpan="2">
                    <asp:TextBox ID="productNameTextBox" runat="server" Width="98%"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
                ...
                <asp:TableCell runat="server">
                    <input type="button" ID="Btn_changeStarProductPic" value="更换图片(分辨率785*199)" onclick="BrowseServer('<%=picURLTextBox.ClientID %>')" /></asp:TableCell>
            </asp:TableRow>
            ...
            <asp:TableRow>
                ...
                <asp:TableCell runat="server" ColumnSpan="2">
                    <asp:TextBox Width="90%" ID="linkURLTextBox" runat="server"></asp:TextBox>
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow>
                <asp:TableCell runat="server" Font-Bold="True" Width="100px">显示排序</asp:TableCell>
                <asp:TableCell runat="server" ColumnSpan="2">
                    <asp:TextBox ID="posIndexTextBox" runat="server"></asp:TextBox>(越大越优先)
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
