<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true"
    CodeFile="ZSAdmin.aspx.cs" Inherits="admin_Default2" ValidateRequest="false" %>

<asp:Content ID="Content1" ContentPlaceHolderID="RightContentPlaceHolder" runat="Server">
    <asp:Panel ID="NewsListPanel" runat="server">
        <div class="savePage">
            <asp:Button ID="Button1" runat="server" Text="添加证书图片" OnClick="Article_New" /></div>
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="名称">
                    <ItemTemplate>
                        <asp:LinkButton ID="LinkButton3" runat="server" CommandName="doEdit" CommandArgument='<%#Eval("ID") %>'
                            OnCommand="Article_Command">
                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("picName")%>'></asp:Label></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:BoundField DataField="picSmall" HeaderText="小图片" />
                <asp:BoundField DataField="picURL" HeaderText="大图片" />
            </Columns>
            <FooterStyle BackColor="#CCCC99" />
            <HeaderStyle BackColor="#6B696B" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#F7F7DE" ForeColor="Black" HorizontalAlign="Right" />
            <PagerTemplate>
                <asp:Button ID="Button5" runat="server" Text="添加证书图片" OnClick="Article_New" />
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:mydbConnectionString %>"
            SelectCommand="SELECT * FROM [ZSTable]"
...
<asp:Table ID="editTable" runat="server" BorderColor="#999999" BorderWidth="0px"
            ...
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" Font-Bold="True" Width="100px">小图片</asp:TableCell>
                <asp:TableCell runat="server" Width="400px">
                    <asp:TextBox ID="Txt_PicURLSmall" runat="server" Width="380px"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell runat="server">
                    <input type="button" ID="Btn_changePicSmall" value="更换图片" onclick="BrowseServer('<%=Txt_PicURLSmall.ClientID %>')" /></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" Font-Bold="True" Width="100px">大图片</asp:TableCell>
                <asp:TableCell runat="server" Width="400px">
                    <asp:TextBox ID="Txt_PicURL" runat="server" Width="380px"></asp:TextBox>
                </asp:TableCell>
                <asp:TableCell ID="TableCell3" runat="server">
                    <input type="button" ID="Btn_changePic" value="更换图片" onclick="BrowseServer('<%=Txt_PicURL.ClientID %>')" /></asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" Font-Bold="True" Width="100px">小图预览</asp:TableCell>
                <asp:TableCell runat="server" ColumnSpan="2">
                    <asp:Image ID="Image_picSmall" runat="server" />
                </asp:TableCell>
            </asp:TableRow>
            <asp:TableRow runat="server">
                <asp:TableCell runat="server" Font-Bold="True" Width="100px">大图预览</asp:TableCell>
                <asp:TableCell runat="server" ColumnSpan="2">
                    <asp:Image ID="Image_pic" runat="server" Width="450px" />
                </asp:TableCell>
            </asp:TableRow>
        </asp:Table>
    </asp:Panel>
